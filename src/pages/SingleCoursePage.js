    ...
    <SingleCourseWrapper>
        ...
        <div className='course-details'>
          ...
          <div className='course-body'>
            ...
            <ul className='course-info'>
              <li>
                <span className='fs-14'>Creado por <span className='fw-6 opacity-08'>{creator}</span></span>
              </li>
              <li className='flex'>
                <span><TbWorld /></span>
      ...
      <div className='course-full bg-white text-dark'>
        <div className='course-learn mx-auto'>
          <div className='course-sc-title'>¿Qué aprenderas?</div>
        ...
        <div className='course-content mx-auto'>
         {/* NOTA: Reemplazar esto por el componente de yet-another-lightbox */}
          <div className='course-sc-title'>Curso</div>
          <ul className='course-content-list'>
              ...
              content && content.map((contentItem, idx) => {
                return (
                  <li key = {idx}>
                    <a href="a" onClick={(e)=>{
                      e.preventDefault();
                      setLightbox(true)}}>{contentItem}</a>
                  </li>
                )
              })
            }
            ...
            <a href="a" onClick={(e)=>{
                      e.preventDefault();
                      window.href("evaluacion")}} style={{backgroundColor: "darkgreen",
                        border: "none",
                        color: "white",
                        padding: "16px",
                        textDecoration: "none",
                        margin: "4px",
                        marginTop: "20px",
                        cursor: "pointer"}}>Hacer evaluacion </a>
                
          
        </div>
      </div> {lightbox === true ? <LightBox/>: undefined}
    </SingleCourseWrapper>
  )
}
